...
document.querySelectorAll('.faq-question').forEach(button => {
    button.addEventListener('click', () => {
        ...
        // Zmieniamy widoczność odpowiedzi
        if (answer.style.display === 'block') {
            answer.style.display = 'none';
            button.classList.remove('active'); // Usuwamy klasę aktywną
            icon.textContent = '+'; // Zmieniamy ikonę na plus
        } else {
            answer.style.display = 'block';
            button.classList.add('active'); // Dodajemy klasę aktywną
            icon.textContent = '×'; // Zmieniamy ikonę na minus
        }
    });
});
